...
Two csv files contatining the training and test data was provided by this source: http://groupware.les.inf.puc-rio.br/har and downloaded to a data folder in the working directory.
